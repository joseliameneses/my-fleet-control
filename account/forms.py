...
class RegisterForm(forms.ModelForm):
    registration = forms.IntegerField(label='Registration')
    # manager = forms.BooleanField(label='Manager', widget=forms.CheckboxInput,required=True, localize=True)
    email = forms.EmailField(label='E-mail')
...
class EditAccountForm(forms.ModelForm):
    ...
    class Meta:
        model = AccountUser
        fields = ['username', 'email', 'name', 'manager']
